...
toss_ins = ["README", "README.md", "LICENSE",
...
wrap_dir = "show_in_windows_explorer"  # Wrap the output in a directory in the ZIP file
output_file = f"blender_show_in_windows_explorer_{tag_name}.zip"  # What to call the ZIP file
